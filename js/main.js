...
helpObj.addEventListener('click', function(){
  ...
  document.getElementById('modalContainer').style = "background: url('media/images/helpButtonImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
...
googleObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/googleImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  googleSoundObj.play();
  const idName = (this.id);
...
teslaObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/teslaImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  teslaSoundObj.play();
  const idName = (this.id);
...
jnjObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/jnjImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  jnjSoundObj.play();
  const idName = (this.id);
...
msftObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/msftLogo.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  msftSoundObj.play();
  const idName = (this.id);
...
appleObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/appleImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  appleSoundObj.play();
  const idName = (this.id);
...
gmeObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/gmeImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  gmeSoundObj.play();
  const idName = (this.id);
...
pfizerObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/pfizerImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  pfizerSoundObj.play();
  const idName = (this.id);
...
amznObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/amznImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  amznSoundObj.play();
  const idName = (this.id);
...
nflxObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/nflxImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  nflxSoundObj.play();
  const idName = (this.id);
...
nvdaObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/nvdaImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  nvdaSoundObj.play();
  const idName = (this.id);
...
btcObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/btcImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  btcSoundObj.play();
  const idName = (this.id);
...
etherObj.addEventListener('click', function(){
  console.log('Lets check out: ' + this.id)
  document.getElementById('modalContainer').style = "background: url('media/images/etherImg.png') center no-repeat, linear-gradient(130deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.4674361861861862) 100%);";
  document.getElementById('modalContainer').style.display = "block";
  stopAllAudio();
  etherSoundObj.play();
  const idName = (this.id);
